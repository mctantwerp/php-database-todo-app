<tr class="odd:bg-orange-100 even:bg-orange-50">
    ...
    <td class="text-center  px-1 py-2 text-orange-800 flex gap-3 justify-start">
        <form method="POST">
            ...
            <?php if ($todo['done'] === 0): ?>
                <button name="check" value="1" class="text-orange-600">
                    <?= svg('check'); ?>
                </button>
            <?php endif; ?>
            <?php if ($todo['done'] === 1): ?>
                <button name="uncheck" value="1" class="text-orange-600">
                    <?= svg('cross'); ?>
                </button>
            <?php endif; ?>
            <button type="submit" name="delete" value="1" class="text-orange-600">
                <?= svg('trash'); ?>
            </button>
        </form>
    </td>
